...
const IconComponent = ({ title, subtitle, imageSrc }: any) => {
    return (
        ...
        <div className="flex flex-row items-center justify-start gap-2 w-full">
            <div className="flex justify-center items-center w-16 h-16 border-[1px] border-gray-100 rounded-lg flex-none">
                <Image src={imageSrc} width={30} height={30} alt={title} />
            </div>
            <div className="text-left">
                <div className="text-[14px] font-bold text-black">{title}</div>
