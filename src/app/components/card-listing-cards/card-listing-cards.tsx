              ...
              <div className="h-[274px]">
                <div className="mt-5 flex flex-row items-center gap-4 mr-10">
                  <div onClick={()=>setPrice(data?.bookingOptions?.selfDrive?.packageType?.package1
                          ?.price)} className={`sm:flex flex-row items-center cursor-pointer justify-between bg-white gap-3 border-[1.5px] border-[#FF0000] px-2 py-2 rounded-lg sm:w-[210px] sm:h-[71px]`}>
                  ...
                  onClick={()=>setPrice(data?.bookingOptions?.selfDrive?.packageType?.package3
                    ?.price)}
                  className="sm:flex flex-row items-center justify-between cursor-pointer bg-white gap-3 border-[1.5px] border-[#FF0000] px-2 py-2 rounded-lg sm:w-[210px] sm:h-[71px]">
                    <span className="font-bold text-[18px] ">
                      {
              ...
              <div className="h-[274px]">
                <div className="mt-5 flex flex-row items-center gap-4 mr-10">
                  ...
                  onClick={()=>setPrice(data?.bookingOptions?.subscription?.packageType
                    ?.package1?.price)}
                  className="sm:flex flex-row items-center cursor-pointer justify-between bg-white gap-3 border-[1.5px] border-[#FF0000] px-2 py-2 rounded-lg sm:w-[210px] sm:h-[71px]">
                    <span className="font-bold text-[18px] ">
                      {
...
360 Free kms
              ...
              {driverType ===
                ...
                <>
                  ...
                  <div className="h-[274px]">
                    <div className="mt-5 flex flex-row items-center gap-4 mr-10">
                      <div className="sm:flex flex-row items-center cursor-pointer justify-between bg-white gap-3 border-[1.5px] border-[#FF0000] px-2 py-2 rounded-lg sm:w-[210px] sm:h-[71px]">
                        <span className="font-bold text-[18px] ">
                          {/* {data?.bookingOptions?.subscription?.package1?.price} */}
              ...
              {priceArray?.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <p className="text-primary text-xs">{item?.kilometers}</p>
                  </div>
                );
              })}
            </div>
                        ...
                        {tabs.map((tab) => (
                          <button
                            ...
                            className={`py-2 px-2 rounded-t-xl mt-2 xs:text-sm text-xs ${
                              activeTab !== tab.name
                                ? "bg-black text-white"
                                : "bg-white text-primary border shadow-xl"
                            }`}
                            onClick={() => setActiveTab(tab.name)}
                          >
                            {tab.name}
