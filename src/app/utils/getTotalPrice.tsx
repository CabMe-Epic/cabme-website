...
export const calculateTotalPrice = (price: number) => {
    const { pickupDate, dropoffDate, pickupTime, dropoffTime } = getReservationData();
    ...
    if (pickupDate && dropoffDate && pickupTime && dropoffTime) {
        ...
        const { days: extractedDays, hours: extractedHours } = extractDaysAndHours(duration);
