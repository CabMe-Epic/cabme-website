    ...
    <div className="max-w-[1400px] m-auto">
      ...
      <main className=" xs:py-8 px-4">
        ...
        <section className="sm:flex flex-row items-start xl:justify-between justify-center gap-10">
          <div className="sticky sm:hidden top-8 z-40 cursor-pointer">
            <Image onClick={() => setShowFilter(!showFilter)} src="/filter.svg" alt="filter" width={50} height={50} />
          </div>
          {
            showFilter ?
              <aside className="basis-1 w-[300px] h-full shadow-filter-shadow p-8 xl:block  sm:hidden sticky left-0 top-20 bg-white z-50 ">
                <div>
