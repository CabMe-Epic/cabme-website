        ...
        <div>
            <main className='max-w-[1250px] m-auto'>
                ...
                <div className=' flex flex-row flex-wrap justify-center gap-10 mt-10'>
                    ...
                    <section>
                        <div className='my-6 p-6 sm:p-10 border flex flex-col items-center justify-center gap-6 sm:gap-10 rounded-lg shadow-md'>
                            <div>
                                <h1 className="text-2xl sm:text-3xl lg:text-[36px] font-bold text-center">CHOOSE PAYMENT METHOD</h1>
                            </div>

                            <div className="max-w-full sm:max-w-[588px] w-full sm:w-[488px] mx-auto bg-white rounded-lg p-4">
                                <h2 className="text-lg sm:text-xl font-semibold mb-4 relative overflow-hidden">Pay Online <span className="border-b-[1px] border-[#000000] w-full absolute top-3 left-32"></span></h2>
                                ...
                                <h2 className="relative text-lg sm:text-xl font-semibold mt-4 mb-2 overflow-hidden">Pay Cash<span className="border-b-[1px] border-[#000000] w-full absolute top-3 left-32"></span></h2>
                    ...
                    <section>
                        <main className="flex flex-col items-center bg-[#FAFAFA] py-10 my-6 rounded-md p-4 ">
                            ...
                            <div className="m-auto my-5">
                                <span className="font-bold text-[20px] sm:text-[24px]">
                                    Fare Details
                                </span>
                            </div>
                            <div className="grid grid-cols-1 items-start justify-center gap-4 font-semibold">
                                <div className="grid grid-cols-2 gap-4 sm:gap-14 justify-center">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Base Fare</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">₹ 5,229</span>
                                </div>

                                <div className="grid grid-cols-2 gap-4 sm:gap-14 justify-center">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Doorstep delivery & pickup</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">₹ 500</span>
                                </div>

                                <div className="grid grid-cols-2 gap-4 sm:gap-14 justify-center">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Insurance & GST</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Included</span>
                                </div>

                                <div className="grid grid-cols-2 gap-4 sm:gap-14 justify-center">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Refundable Deposit</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">₹ 3000</span>
                                </div>

                                <div className="grid grid-cols-2 gap-4 sm:gap-8 justify-center shadow-inner font-bold text-[24px] sm:text-[30px]">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Total</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10 text-[#ff0000]">₹ 7686</span>
                                </div>

                                <div className="grid grid-cols-2 gap-4 sm:gap-14 justify-center">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Kms Limit</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">₹ 506 kms</span>
                                </div>

                                <div className="grid grid-cols-2 gap-4 sm:gap-14 justify-center">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Fuel</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Excluded</span>
                                </div>

                                <div className="grid grid-cols-2 gap-4 sm:gap-14 justify-center">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Extra kms charge</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">₹ 7/km</span>
                                </div>

                                <div className="grid grid-cols-2 gap-4 sm:gap-14 justify-center">
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">Tolls, Parking & Inner-state taxes</span>
                                    <span className="w-[150px] sm:w-[220px] ml-2 sm:ml-10">To be paid by you</span>
                                </div>
                            </div>
                            <div className="w-full flex flex-col items-center">
                                ...
                                <div className="w-full sm:w-[418px] h-[53px] flex flex-row justify-center border-[1.5px] border-[#ff0000] rounded items-center bg-white px-4">
                                ...
                                <div className="my-6 h-[79px] drop-shadow-lg bg-[#E7E7E7] flex flex-row items-center justify-between px-4 py-5 rounded-3xl gap-20 w-full sm:w-auto">
                                    <div className="flex flex-col items-start gap-2">
                                        <div className='text-sm'>Total Amount</div>
                                        <div className="text-[#ff0000] p-0 text-[24px] sm:text-[30px] text-sm nowrap font-bold">₹ 15,000</div>
                                    </div>
                                    <div>
                                        <button className="bg-gradient-to-r from-[#F1301E] to-[#FA4F2F] text-[20px] sm:text-[24px] font-bold text-white w-[150px] sm:w-[178.31px] h-[45px] sm:h-[53.08px] rounded-full drop-shadow-lg">Checkout</button>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col items-center border-[1.5px] w-full sm:w-[423px] py-2 rounded-3xl border-[#ff0000] cursor-pointer">
                                ...
                                <span className="text-[#ff0000] font-bold text-[18px] sm:text-[20px]">Balance on Delivery</span>
                            </div>
                        </main>
                    </section>
