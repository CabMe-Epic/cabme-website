        ...
        <div>
            <main className='max-w-[1250px] m-auto'>
                ...
                <div className="flex items-center justify-center mt-10">
                    <div className="flex relative items-center justify-between w-[1201px] space-x-4">
                        {/* Step 1 */}
                    ...
                    <section>
                        ...
                        {/*  */}
                            ...
                            <div className="grid grid-cols-1 gap-5">
                                ...
                                <div className="grid grid-cols-2 gap-5">
                                <InputField type="text" className="w-full"  placeholder="State" />
                                <InputField type="text" className="w-full" placeholder="Pincode" />
                                </div>
