    ...
    return (
        <div>
            <main className='max-w-[1250px] m-auto'>
                {/*  */}
                <div className="flex items-center justify-start md:justify-center mt-10">
                    <div className="flex relative items-center justify-center md:w-[1201px] space-x-4">
                        {/* Step 1 */}
                        ...
                        <div className="flex-grow p-0 h-[1px] bg-gray-300 border-b-[1px] border-black -z-10 absolute top-[15px]   items-center w-[230px] !md:w-[500px] !lg:w-[1054px]"></div>
                        {/* Step 2 */}
                        <div className="flex items-center">
                            <div className="relative flex  flex-col gap-2 items-center">
                                <div className="w-8 h-8 border-2 border-red-500 rounded-full bg-white flex  items-center justify-center">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 mt-10'>
                    ...
                    <section>
                        <div className='my-6 md:h-[515px] p-10 border flex  flex-col items-center justify-center gap-10 rounded-lg shadow-md'>
                            <div className=''>
                        ...
                        <main className=" flex  flex-col items-center bg-[#FAFAFA] py-10 my-6 rounded-mdz">
                            ...
                            <div className="grid grid-cols-1 items-start justify-center gap-4 font-semibold">
                                <div className="grid grid-cols-2 gap-14  justify-center">
                                    <span className="w-[120px] md:w-[220px] ml-10">Base Fare</span>
                                    <span className="w-[120px] md:w-[220px] ml-10">₹ 5,229</span>
                                </div>

                                <div className="grid grid-cols-2 gap-14  justify-center">
                                    <span className="w-[120px] md:w-[220px] ml-10">Doorstep delivery & pickup</span>
                                    <span className="w-[120px] md:w-[220px] ml-10">₹ 500</span>
                                </div>

                                <div className="grid grid-cols-2 gap-14  justify-center">
                                    <span className="w-[120px] md:w-[220px] ml-10">Insurance & GST</span>
                                    <span className="w-[120px] md:w-[220px] ml-10">Included</span>
                                </div>

                                <div className="grid grid-cols-2 gap-14  justify-center">
                                    <span className="w-[120px] md:w-[220px] ml-10">Refundable Deposit</span>
                                    <span className="w-[120px] md:w-[220px] ml-10">₹ 3000</span>
                                </div>

                                <div className="grid grid-cols-2 w-fit gap-8 justify-center shadow-inner font-bold text-[30px]">
                                    <span className="w-[120px] md:w-[220px] ml-10">Total</span>
                                    <span className="w-[120px] md:w-[220px] ml-10 text-[#ff0000]">₹ 7686</span>
                                </div>

                                <div className="grid grid-cols-2 gap-14  justify-center">
                                    <span className="w-[120px] md:w-[220px] ml-10">Kms Limit</span>
                                    <span className="w-[120px] md:w-[220px] ml-10">₹ 506 kms</span>
                                </div>

                                <div className="grid grid-cols-2 gap-14  justify-center">
                                    <span className="w-[120px] md:w-[220px] ml-10">Fuel</span>
                                    <span className="w-[120px] md:w-[220px] ml-10">Excluded</span>
                                </div>

                                <div className="grid grid-cols-2 gap-14  justify-center">
                                    <span className="w-[120px] md:w-[220px] ml-10">Extra kms charge</span>
                                    <span className="w-[120px] md:w-[220px] ml-10">₹ 7/km</span>
                                </div>

                                <div className="grid grid-cols-2 gap-14  justify-center">
                                    <span className="w-[120px] md:w-[220px] ml-10">Tolls,Parking & Inner-state taxes</span>
                                    <span className="w-[120px] md:w-[220px] ml-10">To be paid by you</span>
                                </div>
                            </div>
                            <div className="m-auto">
                                ...
                                <div className=" w-[340px] md:w-[418px]  h-[53px] flex  flex-row justify-center border-[1.5px] border-[#ff0000] rounded item-center bg-white px-4">
                            ...
                            <div className="flex flex-col items-center border-[1.5px] w-[340px] md:w-[423px] py-2 rounded-3xl border-[#ff0000] cursor-pointer">
