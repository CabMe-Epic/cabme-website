                                    ...
                                    <div className="px-6 py-4">
                                        ...
                                        {selectedOption === 'Monthly' && (
                                            <div className="text-center mb-6 bg-[#E7E7E7] px-4 py-2 rounded-full drop-shadow-lg">
                                                <p className="text-3xl font-semibold text-[#ff0000]">₹ 19,764/month</p>
                                                <p className="text-gray-500">(Inclusive of insurance and maintenance)</p>
                                            </div>
                                        )}
                                        {selectedOption === 'Weekly' && (
                                            <div className="text-center mb-6 bg-[#E7E7E7] px-4 py-2 rounded-full drop-shadow-lg">
                                                <p className="text-3xl font-semibold text-[#ff0000]">₹ 5,000/week</p>
                                                <p className="text-gray-500">(Inclusive of insurance and maintenance)</p>
                                            </div>
                                        )}
                                        {selectedOption === 'Quarterly' && (
                                            <div className="text-center mb-6 bg-[#E7E7E7] px-4 py-2 rounded-full drop-shadow-lg">
                                                <p className="text-3xl font-semibold text-[#ff0000]">₹ 50,000/quarter</p>
                                                <p className="text-gray-500">(Inclusive of insurance and maintenance)</p>
                                            </div>
                                        )}
                                        {selectedOption === 'Yearly' && (
                                            <div className="text-center mb-6 bg-[#E7E7E7] px-4 py-2 rounded-full drop-shadow-lg">
                                                <p className="text-3xl font-semibold text-[#ff0000]">₹ 2,00,000/year</p>
                                                <p className="text-gray-500">(Inclusive of insurance and maintenance)</p>
                                            </div>
                                        )}
                                        <div className="mb-4 px-2">
                                            <div className="flex justify-between  items-center mb-2">
                                                <span className="font-semibold text-[20px] ">Expected date of delivery</span>
                                                <button className="text-[#ff0000] flex flex-row gap-1 items-center text-[12px]">Edit <Image src="/carDetails/pen.png" width={10} height={10} alt="edit" /></button>
                                            </div>
                                            <p className="text-gray-700">Between 26th - 26th May</p>
                                        </div>
                                        <div className="mb-6 px-2">
                                            <div className="flex justify-between  items-center mb-2">
                                                <span className="font-semibold text-[20px]">Place of delivery</span>
                                                <button className="text-[#ff0000] flex flex-row gap-1 items-center text-[12px]">Edit <Image src="/carDetails/pen.png" width={10} height={10} alt="edit" /></button>
                                            </div>
                                        ...
                                        <div className="bg-white drop-shadow-lg p-4 rounded-lg mb-6 w-[439px]">
                                            <div className="text-center mb-6">
                                                <button className="w-[406px] h-[60px] py-2 px-4 border-[1px] border-[#ff0000] text-[#ff0000] rounded shadow-inner font-semibold">Proceed to Check Eligibility</button>
                                            </div>
                                            <div className="mb-0">
                                                <div className="flex flex-row items-center justify-between w-full text-[16px] text-[#000] font-semibold">
                                                    <p className="">Extend anytime at normal prices
                                                    </p>
                                                    <button className="text-[#ff0000]">Details</button>
                                                </div>

                                                <div className="flex flex-row items-center justify-between w-full text-[16px] text-[#000] font-semibold">
                                                    <p className=" ">Return anytime, Just pay fee difference</p> <button className="text-[#ff0000]">Details</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="text-center">
                                            <button className=" w-[421px] h-[50px] rounded-full py-2 px-4 text-white bg-gradient-to-r from-[#F1301E] to-[#FA4F2F] font-bold">Call us to know more</button>
                                        </div>
                                    </div>
                                </div>
                            </main>
