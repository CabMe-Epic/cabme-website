          ...
          Continue
            ...
            <div className="lg:max-w-[1250px] max-w-[750px] m-auto sm:my-16 my-10 mx-auto">
              <h2 className="sm:text-4xl text-xl font-semibold text-center">
                Make <span className="text-primary"> 4 steps</span> to rent a
                car
              </h2>
                ...
                <div className="w-[450px] m-auto">
                  ...
                  <h4 className="font-semibold text-sm sm:text-[28px]">
                    ...
                    <span className="text-primary">
                      {cms?.discountWithBanner?.couponCode}
                    </span>
                  </h4>
                </div>
            ...
            {/* app section */}
            <div
              className="grid sm:grid-cols-2 gap-4 sm:px-10 px-4 sm:py-8 pt-8 pb-4 rounded-xl sm:bg-[url('/svg/taj.png')] bg-[url('/png/taj-mobile.png')] bg-no-repeat bg-cover m-4 sm:my-16 my-10"
            ...
            >
              <div className="max-w-[550px] m-auto">
                ...
                <p className="lg:my-8 sm:my-4 sm:text-[14px] text-xs">
                  The application is available on both apple store and play
                  store. Download Now.
                </p>
              ...
              <div>
                <div className="grid gap-4 max-w-[410px] m-auto">
                  <h2 className="sm:text-4xl text-2xl sm:text-left text-center font-bold">
                    Any{" "}
                    <span className="sm:text-black text-primary">
                      {" "}
                      questions
                    </span>{" "}
                    <br />
                  ...
                  <p className="mb-6 sm:block hidden">
                    If you got any questions that is not in FAQs, please go
                    through the Terms and Conditions. Or reach us at 1800 121
                    6162 or mail us at enquiry.cabme@gmail.com
                  </p>
                </div>
                <Image
                  src={"/png/car-red.png"}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="font-bold sm:text-2xl text-xs">
                        <h3>{item?.count}</h3>
                        <p className="lg:text-[14px] text-sm">
                          {item?.headline}
                        </p>
                      </div>
                    </div>
